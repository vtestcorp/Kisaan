...
public class TC_65_Admin_FarmersMarket_UpdateTiming extends BaseClass{
	...
	public void admin_FarmersMarket_DeactiveMarket() throws Exception {
		...
		test = extent.createTest("TC_65_Admin_FarmersMarket_UpdateTiming", "Admin should be able to update timing of Market shop");
		...
		farmer_Market.enterPickupCity(JsonUtils.getData(DefineConstants.TC_65_Admin_FarmersMarket_UpdateTiming, "Pickup City"));
		farmer_Market.enterPickupZipCode(JsonUtils.getData(DefineConstants.TC_65_Admin_FarmersMarket_UpdateTiming, "Pickup Zip"));
		...
		farmer_Market.select_Date();
		farmer_Market.click_Time();
		farmer_Market.click_FromTime(JsonUtils.getData(DefineConstants.TC_65_Admin_FarmersMarket_UpdateTiming, "From Hr"),
									 JsonUtils.getData(DefineConstants.TC_65_Admin_FarmersMarket_UpdateTiming, "From Min"),
									 JsonUtils.getData(DefineConstants.TC_65_Admin_FarmersMarket_UpdateTiming, "From Period"));
		farmer_Market.click_ToTime(JsonUtils.getData(DefineConstants.TC_65_Admin_FarmersMarket_UpdateTiming, "To Hr"),
									 JsonUtils.getData(DefineConstants.TC_65_Admin_FarmersMarket_UpdateTiming, "To Min"),
									 JsonUtils.getData(DefineConstants.TC_65_Admin_FarmersMarket_UpdateTiming, "To Period"));
		farmer_Market.click_UpdateTiming();
		farmer_Market.verify_SuccessMessageSendEmail(JsonUtils.getData(DefineConstants.TC_65_Admin_FarmersMarket_UpdateTiming, "Success Message Update Time"));
